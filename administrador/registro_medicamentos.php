...
<head>
	...
	<title>REGISTRO DE USO DE MEDICAMENTOS VETERINARIOS</title>
	<?php
...
<body id="body">
	...
	<div class="container-fluid">
		<div id="tablaRegistroMedicamentos"></div>
	</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			if (rol_user == 1 || rol_user == 2) {
				$('#tablaRegistroMedicamentos').load('./vista_admin/vista_registro_medicamentos.php?codigo_orions=<?php echo $codigo; ?>');
			} else {
				alert("Error...");
			}
			...
			$('#eliminarDatosRegistroMedicamentos').click(function() {
				preguntarSiNoRegistroMedicamentos();
			});
		});
	</script>
</body>
