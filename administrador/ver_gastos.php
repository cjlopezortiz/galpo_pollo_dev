...
<head>
	<meta charset="UTF-8">
	<title>Ver todos los gastos de la cosecha</title>
...
<body id="body">
	...
	<div class="container-fluid">
		<div id="contenedorvergastos"></div>
	</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#contenedorvergastos').load('./vista_admin/vista_ver_gastos.php?codigo_orions=' + codigo);
