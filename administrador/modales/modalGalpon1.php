	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="text-center" id="errortipo_alimento"></div>
				<br />
				...
				<div class="text-center" id="errorcolor"></div>
				<br />
				...
				<div class="text-center" id="errordescripcion"></div>
				<br />

			</div>
			<div class="modal-footer">
				<div class="text-center">
					<button type="button" class="btn btn-primary" class="close" id="guardarNuevoGalpon1">
						Agregar cosecha
					</button>
				</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="col-sm-6 text-left">
					<button type="button" class="btn btn-danger" data-dismiss="modal" id="eliminarDatosGalpon1">
						Eliminar
					</button>
				</div>
				<div class="col-sm-6 text-right">
					<button type="button" class="btn btn-warning" data-dismiss="modal" id="actualizaDatosGalpon1">
						Actualizar
					</button>
				</div>
			</div>
...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		$('#modalNuevoGalpon1').on('shown.bs.modal', function() {
