...
if ($rol_user != 1 && $rol_user != 2) {
    ...
    if (isset($_GET['codigo_orions']) && !empty($_GET['codigo_orions'])) {
        ...
        $res_control = $mis_control_aliment->viewControlAlimentos($usuario_codigo, $codigo_orions, $rolId);
    } else {
                ...
                <tbody>
                    ...
                    if (is_array($res_control) || $res_control instanceof Traversable) {
                        foreach ($res_control as $data) {
                            ...
                            if (!empty($codigo_g1)) {
                                $urlamacen = "almacen.php?codigo_orions=" . $codigo_g1;
                            }

                            if (!empty($codigo_g2)) {
                                $urlamacen = "almacen.php?codigo_orions=" . $codigo_g2;
                            }

                            $urlmedicamentos = "#";

                            if (!empty($codigo_g1)) {
                                $urlmedicamentos = "registro_medicamentos.php?codigo_orions=" . $codigo_g1;
                            }

                            if (!empty($codigo_g2)) {
                                $urlmedicamentos = "registro_medicamentos.php?codigo_orions=" . $codigo_g2;
                            }
