                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        <button class="btn btn-primary glyphicon glyphicon-pencil" data-toggle="modal" data-target="#modalEdicionControAlimento" onclick="agregarformControAlimento('<?php echo $datos; ?>')"></button>
                                    </div>
                                </td>
                            </tr>
                    <?php
