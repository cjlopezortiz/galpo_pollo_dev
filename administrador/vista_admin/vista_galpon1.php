...
<div class="col-sm-12">
    ...
    <div class="page-head">
       ...
       <ul class="breadcrumb breadcrumb-modern">
            ...
            <li>
                <a target="_blank" href="galpon1.php">TODOS LOS GALPONES MACHOS</a>
            </li>
            <li>
        ...
        <div class="table-responsive">
            <table id="example" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $cant = 1;
                    foreach ($res as $data) {
                        $cant_galpon1 = $mis_galpon1->countGalponir1(['codigo_orions']);
                        // Datos
                        $datos = $data['codigo'] . "||" .
                            $data['codigo_orions'] . "||" .
                            $data['cantidad_pollo'] . "||" .
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <div class="text-center"><button class="btn btn-primary glyphicon glyphicon glyphicon-pencil" data-toggle="modal" data-target="#modalEdicionGalpon1" onclick="agregarFormGalpon1('<?php echo  $datos ?>')"></button></div>
                            </td>
                        </tr>
        ...
        <br />
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalNuevoGalpon1">Crear cosecha</button>
        <br />
    </div>
</div>
<script>
