...
$usuario_sesion_id = isset($_SESSION['codigo']) ? $_SESSION['codigo'] : (isset($_SESSION['usuario_codigo']) ? $_SESSION['usuario_codigo'] : null);
...
if (isset($_GET['accion'])) {
    ...
    if ($accion == 'registrar') {
        ...
        // Seguridad: Si no es admin, solo puede modificar su propio código
        if (isset($_SESSION['rol_id']) && $_SESSION['rol_id'] != 1 && $codigo != $usuario_sesion_id) {
            $codigo = $usuario_sesion_id;
        }
        ...
        // Seguridad: Solo el usuario activo o admin puede eliminar el registro
        if (isset($_SESSION['rol_id']) && $_SESSION['rol_id'] != 1 && $codigo != $usuario_sesion_id) {
            $codigo = $usuario_sesion_id;
        }
